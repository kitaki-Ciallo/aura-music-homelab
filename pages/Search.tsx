...
const Search: React.FC = () => {
    ...
    const results = (searchQuery && library) ? library.filter(song =>
            ...
            <div className="space-y-2">
                {searchQuery ? (
                    ...
                    library && library.length > 0 && (
                        <div className="text-white/30 text-sm mt-4 text-center py-10">Type to search across {library.length} songs</div>
                    )
                )}
            </div>
        </div>
